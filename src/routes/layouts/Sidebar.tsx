                ...
                <div>
                    <div className="flex">
                        <div className="image-container">
                            <img className="rounded-full overlay w-24 h-24 top-3 left-14 border-solid border-4 border-white" src={'https://images.pexels.com/photos/614810/pexels-photo-614810.jpeg?cs=srgb&dl=pexels-simon-robben-614810.jpg&fm=jpg'} alt="Overlay Image" />
                            <img src={profile} alt="Base Image" />
                        </div>
                        <div className="absolute top-[110px] left-[35px] flex flex-col items-center">
                            <span className='text-md font-bold' >{userDetails?.displayName}</span>
